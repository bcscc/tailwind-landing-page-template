      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4 text-neutral-300">"Life's too short to build something nobody wants" - Ash Maurya</h2>
            <p className="text-xl text-gray-600">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur excepteur sint occaecat cupidatat.</p>
          </div>

          {/* Items */}
          <div className="max-w-sm mx-auto grid gap-6 md:grid-cols-1 lg:grid-cols-3 items-stretch md:max-w-2xl lg:max-w-none" data-aos="zoom-y-out">
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-2">Empathize</h4>
              <p className="text-gray-600 text-center">Identify problem spaces and market opportunities. Hold empathy with the customers to understand their needs.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-2">Envision</h4>
              <p className="text-gray-600 text-center">Define the reason to build a product, and what needs to be built. Prioritize and solve the most important problems first.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center p-6 bg-white rounded shadow-xl">
              ...
              <h4 className="text-xl font-bold leading-snug tracking-tight mb-2">Engage</h4>
              <p className="text-gray-600 text-center">Bring in cross-functional teams to turn an idea into a launched product. Lead the teams in realizing the long-term vision of the product.</p>
            </div>
